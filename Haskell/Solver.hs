...
exprToSMT m (App e1 Types.And e2) = S.svAnd (exprToSMT m e1) (exprToSMT m e2)
exprToSMT m (App e1 Or e2) = S.svOr (exprToSMT m e1) (exprToSMT m e2)
exprToSMT m (Not e) = S.svNot (exprToSMT m e)
exprToSMT m (Deref r) = case M.lookup ("mem_" ++ show r) m of
  Just val -> val
...
gatherFreeE (Deref e) = gatherFreeE e <> S.singleton ("mem_" ++ show e, S.KBounded True 32)
